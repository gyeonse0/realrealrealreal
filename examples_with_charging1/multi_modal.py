...
backup_file_path = r'C:\Users\User\OneDrive\바탕 화면\examples_with_charging1\data\multi_modal_data_backup.vrp'
#updated_vrp_file_path = r'C:\Users\User\OneDrive\바탕 화면\examples_with_charging1 - 복사본\data\updated_multi_modal_data.vrp'

file_reader = FileReader()
data = file_reader.read_vrp_file(vrp_file_path)

file_reader.randomize_vrp_data(data["logistic_load"], size=1, seed=SEED, mean=30, key_seed=910)
file_reader.randomize_vrp_data(data["availability_landing_spot"], size=5, seed=SEED, key_seed=12)
file_reader.randomize_vrp_data(data["customer_drone_preference"], size=5, seed=SEED, key_seed=34)
file_reader.randomize_vrp_data(data["price"], size=1, seed=SEED, mean=100, key_seed=56)
file_reader.randomize_vrp_data(data["priority_delivery_time"], size=5, seed=SEED, mean=45, stddev=15, key_seed=78)

#file_reader.write_vrp_file(updated_vrp_file_path, data)
...
destroy_operators = [destroyer.random_removal, destroyer.can_drone_removal, destroyer.high_cost_removal]
repair_operators = [Rep.drone_first_truck_second, Rep.truck_first_drone_second, Rep.heavy_truck_repair] #, Rep.light_drone_repair]
