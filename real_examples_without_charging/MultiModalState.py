        ...
        for route in self.routes:
            ...
            for idx in range(1, len(route)):
                if route[idx][1] == CATCH or ((route[idx][1] == FLY) and (route[idx-1][1] in [ONLY_TRUCK, ONLY_DRONE])):
                    ...
                    drone_energy_consumption = self.detail_drone_modeling(weight,drone_time)+ drone_energy_consumption_per_meter * 0.96 * 50
                    ...
                    if fly==1:
                        ...
                        drone_energy_consumption = drone_energy_consumption_per_meter * 1.18 * 50 + self.detail_drone_modeling(weight,drone_time)
