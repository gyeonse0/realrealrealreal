...
# 파일 경로 설정 및 데이터 저장
desktop_path = r"C:\Users\User\OneDrive\바탕 화면\realrealrealreal-main\realrealrealreal-main\real_examples_with_charging(GALNS)\data\multi_modal_data.vrp"
